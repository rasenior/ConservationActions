...
loglinear_interpolation <- function (x, 
                                     lothresh = 1000, lotarget = 1, 
                                     hithresh = 250000, hitarget = 0.1) 
{
...
# Coerce logical variables to numeric
logivar <- sapply(names(all_iucn), function(i) class(all_iucn[,i]))
logivar <- names(logivar)[logivar == "logical"]
